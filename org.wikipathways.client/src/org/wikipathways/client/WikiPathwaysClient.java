...
/**
 * A client API that provides access to the WikiPathways REST webservice. For
 * more documentation on the webservice, see:
 * http://wikipathways.org/index.php/Help:WikiPathways_Webservice/API
 * 
 * @author thomas, msk, finterly
 */
...
//		MIMShapes.registerShapes(); // no longer have mim shapes...
	...
	/**
	 * Get a info about the pathway (without getting the actual GPML code).
	 */
	...
	/**
	 * Get a list of pathways tagged with any ontology term that is the child of the
	 * given Ontology term.
	 */
	...
	/**
	 * Get a list of external references on the pathway (gene, protein or metabolite
	 * ids), translated to the given database system.
	 * 
	 * @param id         The pathway id
	 * @param dataSource The data source to translate to (e.g.
	...
	/**
	 * Utility method to create a pathway model from the webservice class WSPathway.
	 * 
	 * @param wsp The WSPathway object returned by the webservice.
	 * @return The org.pathvisio.model.Pathway model representation of the GPML
	 *         code.
	 * @throws ConverterException
	 */
	public static PathwayModel toPathway(WSPathway wsp) throws ConverterException {
	...
	/**
	 * Update a pathway on WikiPathways. Note: you need to login first, see:
	 ...
	 * @param revision    The revision these changes were based on (to prevent
	 *                    conflicts)
	...
	/**
	 * Creates a new pathway on WikiPathways. Note: you need to login first, see:
	 * {@link #login(String, String)}.
	 * 
	 * @param pathway The pathway to create on WikiPathways
	 * @return The WSPathwayInfo object, containing the identifier and revision of
	 *         the created pathway.
	 * @throws RemoteException
	 * @throws ConverterException
	 * @throws UnsupportedEncodingException
	...
	/**
	 * Apply a curation tag to a pathway. Will overwrite existing tags with the same
	 * name.
	 * 
	 * @param id       The pathway identifier
	...
	public WSCurationTagHistory[] getCurationTagHistory(String id, Date cutoff) throws RemoteException {
		...
		if (hist == null)
			hist = new WSCurationTagHistory[0];
		return hist;
	}
	...
	/**
	 * Login using your WikiPathways account. You need to login in order to make
	 * changes to pathways.
	 * 
	...
	/**
	 * Search for pathways containing one of the given xrefs by taking into account
	 * cross-references to other database systems.
	 * 
	 * @param xrefs
	 * @return
	 * @throws RemoteException
	...
	public File getColoredPathway(String pwId, String revision, String[] graphId, String[] color, String fileType,
